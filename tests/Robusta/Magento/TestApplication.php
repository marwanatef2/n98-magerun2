...
class TestApplication
{
    ...
    {
        if (null === $varname) {
            $varname = 'Robusta_MAGERUN2_TEST_MAGENTO_ROOT';
        }
        if (null === $basename) {
            $basename = '.robusta-magerun2';
        }
    ...
    public function getApplication()
    {
        if ($this->application === null) {
            ...
            $application = $mockObjectGenerator->getMock(\Robusta\Magento\Application::class, ['getMagentoRootFolder']);
