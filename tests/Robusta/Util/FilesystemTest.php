 ...
 * @covers Robusta\Util\Filesystem
 */
class FilesystemTest extends TestCase
{
    ...
    {
        $tmp = sys_get_temp_dir();
        $basePath = $tmp . "/robusta_testdir-never-existed";
