...
use Robusta\Magento\Application\Config;
use Robusta\Magento\Application\ConfigurationLoader;
use Robusta\Magento\Application\Console\Events;
use Robusta\Magento\Application\DetectionResult;
use Robusta\Magento\Application\Magento1Initializer;
use Robusta\Magento\Application\Magento2Initializer;
use Robusta\Magento\Application\MagentoDetector;
use Robusta\Magento\Command\DummyCommand;
use Robusta\Util\Console\Helper\TwigHelper;
...
";
    ...
    /**
     * @see \Robusta\Magento\Application::setConfigurationLoader()
    ...
    public function registerMagentoCoreCommands(OutputInterface $output): void
    {
        ...
        try {
            \Robusta\Magento\Application\Magento2Initializer::loadMagentoBootstrap($magentoRootFolder);
        } catch (Exception $ex) {
    ...
    public function setConfigurationLoader(ConfigurationLoader $configurationLoader)
    {
        if ($this->config) {
            ...
            /* @see \Robusta\Magento\Application::init() */
    ...
    protected function getDefaultInputDefinition(): InputDefinition
    {
        ...
        $skipExternalConfig = new InputOption(
            ...
            '',
            InputOption::VALUE_NONE,
            'Do not check if robusta-magerun runs as root'
        );
        $inputDefinition->addOption($skipExternalConfig);
