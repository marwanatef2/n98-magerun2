...
class ConfigurationLoader
{
     ...
     * @var string
     */
    protected $customConfigFilename = 'robusta-magerun2.yaml';
    ...
    /**
     * Check if there is a user config file. ~/.robusta-magerun.yaml
     *
     * @param array $config
    ...
    /**
     * MAGENTO_ROOT/app/etc/robusta-magerun.yaml
     *
     * @param string $magentoRootFolder
     * @param string $magerunStopFileFolder
     * @param array $config
