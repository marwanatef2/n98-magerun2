...
You are running a Magento 1.x instance. This version of robusta-magerun is not compatible
with Magento 1.x. Please use robusta-magerun (version 1) for this shop.
...
------------------</info>
    ...
    <comment>curl -O https://files.magerun.net/robusta-magerun.phar</comment>

<info>Download with wget
------------------</info>

    <comment>wget https://files.magerun.net/robusta-magerun.phar</comment>
...
MAGENTOHINT;
        ...
        throw new RuntimeException('This version of robusta-magerun is not compatible with Magento 1');
    }
}
