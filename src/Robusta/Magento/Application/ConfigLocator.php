...
class ConfigLocator
{
    ...
    /**
     * Obtain the user-config-file, it is placed in the homedir, e.g. ~/.robusta-magerun2.yaml
     *
    ...
    /**
     * Obtain the project-config-file, it is placed in the magento app/etc dir, e.g. app/etc/robusta-magerun2.yaml
     *
     * @return ConfigFile|null
     */
     ...
     * prefixed with a dot: stop-file-folder/.robusta-magerun2.yaml
     *
