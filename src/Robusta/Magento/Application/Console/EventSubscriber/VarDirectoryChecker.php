...
class VarDirectoryChecker implements EventSubscriberInterface
{
    ...
    public function checkForVarDirectoryProblem(ConsoleCommandEvent $event): bool
    {
        ...
        $event->getOutput()->writeln([
            ...
            '',
            'robusta-magerun2 is using the fallback folder. If there is another folder configured for Magento, this ' .
            'can cause serious problems.',
            'Please refer to https://github.com/netz98/robusta-magerun/wiki/File-system-permissions ' .
