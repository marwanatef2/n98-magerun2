...
namespace Robusta\Magento\Command\Installer;

use Robusta\Magento\Command\AbstractMagentoCommand;
use Robusta\Magento\Command\Installer\SubCommand\SubCommandFactory;
 ...
 * @package Robusta\Magento\Command\Installer
 */
...
Example of an unattended Magento CE 2.0.0 installation:
   ...
   $ robusta-magerun2.phar install --dbHost="localhost" --dbUser="mydbuser" \
...
HELP;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $subCommandFactory = $this->createSubCommandFactory(
            $input,
            $output,
            'Robusta\Magento\Command\Installer\SubCommand' // sub-command namespace
        );
