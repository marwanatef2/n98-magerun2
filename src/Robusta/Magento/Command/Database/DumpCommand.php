...
use Robusta\Magento\Command\Database\Compressor\Compressor;
use Robusta\Util\Console\Enabler;
use Robusta\Util\Console\Helper\DatabaseHelper;
use Robusta\Util\Exec;
use Robusta\Util\VerifyOrDie;
...
Extended: https://github.com/netz98/robusta-magerun/wiki/Stripped-Database-Dumps
HELP;
