...
class StatusCommand extends AbstractShowCommand
{
    ...
    protected $_specialFormat = [
        'Uptime' => ['Robusta\Util\TimeElapsed', 'short'],
    ];
...
HELP;
     ...
     * @param      $datetime
     * @param bool $full
     * @deprecated since 1.3.2, use callback "Robusta\Util\TimeElapsed::short" instead
     * @see \Robusta\Util\TimeElapsed::short()
     *
     * @return string
     */
