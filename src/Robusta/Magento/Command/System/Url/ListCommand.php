...
/**
 * Class ListCommand
 * @package Robusta\Magento\Command\System\Url
 */
...
- Create a list of product urls only:
   ...
   $ robusta-magerun2.phar sys:url:list --add-products 4
...
- Create a list of all products, categories and cms pages of store 4 
  and 5 separating host and path (e.g. to feed a jmeter csv sampler):
   ...
   $ robusta-magerun2.phar sys:url:list --add-all 4,5 '{host},{path}' > urls.csv
