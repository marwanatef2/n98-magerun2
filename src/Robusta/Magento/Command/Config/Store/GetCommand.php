...
use Robusta\Magento\Command\Config\AbstractConfigCommand;
...
HELP;
    ...
    protected function renderAsTable(OutputInterface $output, $table, $format)
    {
        ...
        /* @var $tableHelper \Robusta\Util\Console\Helper\TableHelper */
    ...
    protected function renderAsUpdateScript(OutputInterface $output, $table)
    {
        ...
        $output->writeln('# generated by robusta-magerun');
