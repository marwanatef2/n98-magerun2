...
Simply place a script in folder */usr/local/share/robusta-magerun/scripts* or in your home dir
in folder *<HOME>/.robusta-magerun/scripts*.
...
The first line of the script can contain a comment (line prefixed with #) which will be displayed as description.
   ...
   $ robusta-magerun2.phar script:repo:list
HELP;
        $this->setHelp($help);
    }
